...
<?php
	...
	if($extract->num_rows>0){
		...
		while($row = $extract-> fetch_assoc()){
			...
			echo "<td class='total'></td><td class='total' id='total2'>TOTAL:</td><td class='total' id='total2'>".$float_total."</td><td> <a href='edit.php?orderid=$row[orderid]'>Edit</a></td><td><a href='delete_order.php?orderid=$row[orderid]'>Delete</a></td><td><a href='paymentsy.php?orderid=$row[orderid]'>Payment</a></td>";
		}
